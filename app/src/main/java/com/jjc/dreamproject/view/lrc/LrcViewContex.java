...
public class LrcViewContex {
	...
	public int HightRowColor = Color.GREEN;// 高亮行字体颜色
	public int TrySelectRowColor = R.color.NORMAL;// 尝试选择行字体颜色
	public int MessageColor = Color.GREEN;// 信息字体颜色
	public int SelectLineColor = Color.GREEN;// 选择线颜色
	public int TimeTextColor = Color.GREEN;// 选择线颜色
